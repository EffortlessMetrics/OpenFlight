...
fn generate_feature_status_with_metrics(
    ...
    output.push_str("**Generated:** deterministic (timestamp omitted)\n\n");
    output.push_str("**Git Commit:** deterministic (commit omitted)\n\n");
...
pub fn run_ac_status() -> Result<()> {
    ...
    full_report.push_str("  Generated at: deterministic (timestamp omitted)\n");
    full_report.push_str("  Git commit: deterministic (commit omitted)\n");
