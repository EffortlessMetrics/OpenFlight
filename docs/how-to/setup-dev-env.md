...
This will:
- Build the Flight Hub service with Rust 1.93
...
This shell includes Rust 1.93, `protoc`, `pkg-config`, libusb, and the optional cargo tools used by `cargo xtask validate`.
