...
//!
//! Covers record types, serialization round-trips, file I/O, ring buffer
//! semantics, timestamp behaviour, corrupt-file handling, error paths,
//! analysis utilities, export formats, and property-based invariants.
...
async fn write_test_file(
    ...
    // Yield to let the writer task drain the channel.
    for _ in 0..32 {
...
// ═════════════════════════════════════════════════════════════════════
// 3. File writing and reading (BlackboxWriter / BlackboxReader)
// ═════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════
// 5. Timestamp ordering and precision
// ═════════════════════════════════════════════════════════════════════
...
#[tokio::test]
async fn stop_before_start_returns_error() {
...
// ═════════════════════════════════════════════════════════════════════
// 10. Export doc (FBB file-level) depth tests
// ═════════════════════════════════════════════════════════════════════
...
// ═════════════════════════════════════════════════════════════════════
// 11. Truncation and boundary tests
// ═════════════════════════════════════════════════════════════════════
