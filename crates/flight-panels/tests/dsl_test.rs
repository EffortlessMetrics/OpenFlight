...
fn test_evaluator_initialization() {
    ...
    use flight_core::rules::{BytecodeOp, BytecodeProgram, CompareOp};
    ...
    let _actions = evaluator.evaluate(
        &flight_core::rules::CompiledRules {
            bytecode: program,
...
fn test_rate_limiting() {
    ...
    use flight_core::rules::{Action, BytecodeOp, BytecodeProgram};
...
fn test_zero_allocation_constraint() {
    ...
    // Create program
    use flight_core::rules::{Action, BytecodeOp, BytecodeProgram, CompareOp};
