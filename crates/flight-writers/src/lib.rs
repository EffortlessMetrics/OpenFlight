...
impl Writers {
    ...
    pub fn new<P: AsRef<Path>>(config_dir: P, golden_dir: P, backup_dir: P) -> AnyResult<Self> {
    ...
    pub async fn apply_writer(&self, writer: &WriterConfig) -> AnyResult<ApplyResult> {
    ...
    pub async fn verify(&self, sim: SimulatorType, version: &str) -> AnyResult<VerifyResult> {
    ...
    pub async fn rollback(&self, rollback_id: &str) -> AnyResult<RollbackResult> {
    ...
    pub async fn test_golden_files(&self, sim: SimulatorType) -> AnyResult<GoldenTestResult> {
