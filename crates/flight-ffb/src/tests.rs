...
mod trim_correctness_tests {
    ...
    fn test_trim_limits_validation() {
        ...
        assert!(valid_limits.validate_trim_limits().is_ok(), "Valid limits should pass validation");
        ...
        assert!(invalid_rate.validate_trim_limits().is_err(), "Negative rate should fail validation");
        ...
        assert!(invalid_jerk.validate_trim_limits().is_err(), "Negative jerk should fail validation");
        ...
        assert!(inconsistent_limits.validate_trim_limits().is_err(), "Inconsistent limits should fail validation");
    }
