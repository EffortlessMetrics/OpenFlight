...
**Rust versions**: stable, 1.93
**Timeout**: 10 minutes (Ubuntu), 20 minutes (Windows)

### 3. MSRV Check (`msrv-check`)
**Purpose**: Ensures code builds with Minimum Supported Rust Version (1.93)
...
- ✅ **MSRV**: Code must build with Rust 1.93
...
4. **MSRV compliance**: Code builds with Rust 1.93
