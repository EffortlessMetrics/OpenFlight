...
The local development environment uses Docker Compose to provide a consistent, reproducible development setup with Rust 1.93 and edition 2024.
...
2. **Start the development environment**:
   ...
   This will:
      - Build the flight-service container using Rust 1.93
