...
- **Packaging & Distribution**:
    ...
    - **Linux packaging**: Debian `.deb` package with udev rules, systemd user service unit, postinst/postrm scripts, and automated Rust `cargo xtask deb-build` package builder.
